...
// Bypass governance delay to halt the stepper
contract MkrSkyFeeStepperMom {
    ...
    modifier onlyOwner {
        require(msg.sender == owner, "MkrSkyFeeStepperMom/only-owner");
        _;
    }

    modifier auth {
        require(isAuthorized(msg.sender, msg.sig), "MkrSkyFeeStepperMom/not-authorized");
        _;
    }

    constructor(address _stepper) {
